#Game created that is played on a Basys3 Board. On the right two seven segment displays, a hex or decimal number will be displayed. The two left seven segment displays displays the current score.
